...
static ConVar bot_mimic_yaw_offset("bot_mimic_yaw_offset", "0", FCVAR_CHEAT, "Offsets the bot yaw.");
...
//-----------------------------------------------------------------------------
CBasePlayer *PuppetBotPutInServer(bool bFrozen, int iTeam)
{
