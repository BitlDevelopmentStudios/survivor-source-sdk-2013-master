...
// Derived classes
typedef CHL2MP_Player CPlayer;
typedef CBaseCombatWeapon CBaseWeapon;

// Similar functions
#define ToInPlayer ToHL2MPPlayer
...
#define IsSniper() ClassMatches( "sniper_rifle" )
#define IsShotgun() ClassMatches( "shotgun" )
#define IsShotgunDouble() ClassMatches( "shotgundouble" )
#define IsHealgun() ClassMatches( "healgun" )
#define IsCrossbow() ClassMatches( "crossbow" )
#define IsSLAM() ClassMatches( "slam" )
#define IsPistol() ClassMatches( "pistol" )
#define IsDualPistol() ClassMatches( "dualpistol" )
