...
#include "survivor_factionclassmenu.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSurvivorFactionClassMenu::CSurvivorFactionClassMenu(IViewPort *pViewPort) : Frame(NULL, PANEL_FACTIONCLASS)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/FactionClassMenu.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CSurvivorFactionClassMenu::~CSurvivorFactionClassMenu()
{
}
...
//-----------------------------------------------------------------------------
void CSurvivorFactionClassMenu::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CSurvivorFactionClassMenu::ShowPanel(bool bShow)
{
...
void CSurvivorFactionClassMenu::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CSurvivorFactionClassMenu::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CSurvivorFactionClassMenu::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CSurvivorFactionClassMenu::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CSurvivorFactionClassMenu::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CSurvivorFactionClassMenu::SetLabelText(const char *textEntryName, const char *text)
{
...
void CSurvivorFactionClassMenu::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CSurvivorFactionClassMenu::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
