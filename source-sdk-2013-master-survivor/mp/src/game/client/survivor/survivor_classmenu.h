...
#ifndef SURVIVOR_CLASSMENU_H
#define SURVIVOR_CLASSMENU_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CSurvivorClassMenu : public vgui::Frame, public IViewPortPanel
{
private:
	DECLARE_CLASS_SIMPLE( CSurvivorClassMenu, vgui::Frame );

public:
	CSurvivorClassMenu(IViewPort *pViewPort);
	virtual ~CSurvivorClassMenu();
