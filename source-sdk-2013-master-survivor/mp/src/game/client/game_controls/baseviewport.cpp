...
void CBaseViewport::CreateDefaultPanels( void )
{
	...
	AddNewPanel(CreatePanelByName(PANEL_TEAM_FFA), "PANEL_TEAM_FFA");
	AddNewPanel( CreatePanelByName( PANEL_CLASS ), "PANEL_CLASS" );
	AddNewPanel(CreatePanelByName(PANEL_FACTION), "PANEL_FACTION");
	AddNewPanel(CreatePanelByName(PANEL_FACTIONCLASS), "PANEL_FACTIONCLASS");
