...
static ConVar hud_deathnotice_time( "hud_deathnotice_time", "8", 0 );
...
private:
	...
	CPanelAnimationVar(float, m_flSpectatorYPosAdd, "SpectatorYPosAdd", "24");
...
void CHudDeathNotice::Paint()
{
	...
	if (pLocalPlayer != NULL)
	{
		...
		{
			yStart += (int)m_flSpectatorYPosAdd;
		}
		else
		{
			yStart = GetClientModeHL2MPNormal()->GetDeathMessageStartHeight();
		}
	}
	else
	{
