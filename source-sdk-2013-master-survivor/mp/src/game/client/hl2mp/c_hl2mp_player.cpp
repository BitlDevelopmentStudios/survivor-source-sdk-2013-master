...
IMPLEMENT_CLIENTCLASS_DT(C_HL2MP_Player, DT_HL2MP_Player, CHL2MP_Player)
	...
	RecvPropInt(RECVINFO(m_iFaction)),
	RecvPropInt(RECVINFO(m_iGender)),
	RecvPropInt(RECVINFO(m_WeaponPresetPrimary)),
	RecvPropInt(RECVINFO(m_WeaponPresetSecondary)),
	RecvPropInt(RECVINFO(m_WeaponPresetMelee)),
...
static ConVar cl_preferredgender("cl_preferredgender", "0", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_SERVER_CAN_EXECUTE, "Player Preferred Gender. 0 for male, 1 for female");
...
int C_HL2MP_Player::GetWeaponPreset(int iSlotNum)
{
	if (iSlotNum == 0)
	{
