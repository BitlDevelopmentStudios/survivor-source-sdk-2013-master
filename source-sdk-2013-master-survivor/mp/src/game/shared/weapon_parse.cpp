...
void FileWeaponInfo_t::Parse( KeyValues *pKeyValuesData, const char *szWeaponName )
{
	...
	Q_strncpy( szViewModelRed, pKeyValuesData->GetString("viewmodel_red"), MAX_WEAPON_STRING );
	Q_strncpy( szViewModelBlue, pKeyValuesData->GetString("viewmodel_blue"), MAX_WEAPON_STRING );
	...
	m_iBotWeaponRange = pKeyValuesData->GetInt("BotWeaponRange", 0);
