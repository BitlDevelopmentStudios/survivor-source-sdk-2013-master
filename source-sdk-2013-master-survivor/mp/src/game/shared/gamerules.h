...
extern ConVar survivor_player_announcervoicemode;
extern ConVar survivor_player_announcer;
extern ConVar survivor_hitsound;
extern ConVar survivor_randomizer;
