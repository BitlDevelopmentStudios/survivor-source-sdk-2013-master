...
// SHARED
	...
	char					szViewModelRed[MAX_WEAPON_STRING];			// View model of this weapon
	char					szViewModelBlue[MAX_WEAPON_STRING];			// View model of this weapon
	...
	// This helps SURVIVOR bots determine what range to fire their weapons at.
	int						m_iBotWeaponRange;
