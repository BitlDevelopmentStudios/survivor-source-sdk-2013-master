...
//Survivor Cvars
ConVar survivor_player_announcervoicemode("survivor_player_announcervoicemode", "1", FCVAR_REPLICATED | FCVAR_NOTIFY);
ConVar survivor_player_announcer("survivor_player_announcer", "1", FCVAR_REPLICATED | FCVAR_NOTIFY);
ConVar survivor_hitsound("survivor_hitsound", "1", FCVAR_REPLICATED | FCVAR_NOTIFY);
ConVar survivor_randomizer("survivor_randomizer", "0", FCVAR_REPLICATED | FCVAR_NOTIFY);
