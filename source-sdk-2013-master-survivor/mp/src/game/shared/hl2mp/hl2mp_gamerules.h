...
enum HL2MP_Classes
{
	SURVIVOR_CLASS_UNDEFINED = 0,
	SURVIVOR_CLASS_RANGER,
	SURVIVOR_CLASS_MEDIC,
	SURVIVOR_CLASS_SOLDIER,
	SURVIVOR_CLASS_SNIPER,
	SURVIVOR_CLASS_ENGINEER,
...
enum HL2MP_Factions
{
	SURVIVOR_FACTION_RESISTANCE,
	SURVIVOR_FACTION_COMBINE,

	SURVIVOR_FACTION_COUNT
};

enum HL2MP_Genders
{
	SURVIVOR_GENDER_MALE,
	SURVIVOR_GENDER_FEMALE,

	SURVIVOR_GENDER_COUNT
};
...
public:
	...
	virtual const unsigned char *GetEncryptionKey( void ) { return (unsigned char *)"sU7v1V0r"; }
