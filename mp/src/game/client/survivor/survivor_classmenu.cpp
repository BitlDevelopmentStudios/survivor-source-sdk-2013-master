...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSurvivorClassMenu::CSurvivorClassMenu(IViewPort *pViewPort) : Frame(NULL, PANEL_CLASS)
{
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CSurvivorClassMenu::~CSurvivorClassMenu()
{
}
...
//-----------------------------------------------------------------------------
void CSurvivorClassMenu::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CSurvivorClassMenu::ShowPanel(bool bShow)
{
...
void CSurvivorClassMenu::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CSurvivorClassMenu::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CSurvivorClassMenu::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CSurvivorClassMenu::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CSurvivorClassMenu::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CSurvivorClassMenu::SetLabelText(const char *textEntryName, const char *text)
{
...
void CSurvivorClassMenu::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CSurvivorClassMenu::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
