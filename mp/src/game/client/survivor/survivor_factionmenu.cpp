...
#include "survivor_factionmenu.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSurvivorFactionMenu::CSurvivorFactionMenu(IViewPort *pViewPort) : Frame(NULL, PANEL_FACTION)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/FactionMenu.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CSurvivorFactionMenu::~CSurvivorFactionMenu()
{
}
...
//-----------------------------------------------------------------------------
void CSurvivorFactionMenu::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CSurvivorFactionMenu::ShowPanel(bool bShow)
{
...
void CSurvivorFactionMenu::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CSurvivorFactionMenu::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CSurvivorFactionMenu::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CSurvivorFactionMenu::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CSurvivorFactionMenu::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CSurvivorFactionMenu::SetLabelText(const char *textEntryName, const char *text)
{
...
void CSurvivorFactionMenu::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CSurvivorFactionMenu::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
