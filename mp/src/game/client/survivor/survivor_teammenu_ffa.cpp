...
#include "survivor_teammenu_ffa.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSurvivorTeamMenuFFA::CSurvivorTeamMenuFFA(IViewPort *pViewPort) : Frame(NULL, PANEL_TEAM_FFA)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/TeamMenu_FFA.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CSurvivorTeamMenuFFA::~CSurvivorTeamMenuFFA()
{
}
...
//-----------------------------------------------------------------------------
void CSurvivorTeamMenuFFA::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CSurvivorTeamMenuFFA::ShowPanel(bool bShow)
{
...
void CSurvivorTeamMenuFFA::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CSurvivorTeamMenuFFA::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CSurvivorTeamMenuFFA::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CSurvivorTeamMenuFFA::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CSurvivorTeamMenuFFA::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CSurvivorTeamMenuFFA::SetLabelText(const char *textEntryName, const char *text)
{
...
void CSurvivorTeamMenuFFA::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CSurvivorTeamMenuFFA::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
