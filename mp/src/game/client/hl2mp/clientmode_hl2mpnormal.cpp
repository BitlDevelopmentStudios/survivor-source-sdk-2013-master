...
#include "survivor/survivor_classmenu.h"
#include "survivor/survivor_teammenu_ffa.h"
#include "survivor/survivor_factionmenu.h"
#include "survivor/survivor_factionclassmenu.h"
...
IViewPortPanel* CHudViewport::CreatePanelByName( const char *szPanelName )
{
	...
	{
		newpanel = new CSurvivorClassMenu(this);
		return newpanel;
	}
	else if (Q_strcmp(PANEL_TEAM_FFA, szPanelName) == 0)
	{
		newpanel = new CSurvivorTeamMenuFFA(this);
		return newpanel;
	}
	else if (Q_strcmp(PANEL_FACTION, szPanelName) == 0)
	{
		newpanel = new CSurvivorFactionMenu(this);
		return newpanel;
	}
	else if (Q_strcmp(PANEL_FACTIONCLASS, szPanelName) == 0)
	{
		newpanel = new CSurvivorFactionClassMenu(this);
		return newpanel;
	}
