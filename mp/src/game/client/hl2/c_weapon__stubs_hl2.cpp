...
STUB_WEAPON_CLASS( weapon_dualrpg, WeaponDualRPG, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_dualpistol, WeaponDualPistol, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_shotgundouble, WeaponShotgunDouble, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_gatling, WeaponGatling, C_HLSelectFireMachineGun );
STUB_WEAPON_CLASS( weapon_sniper_rifle, WeaponSniperRifle, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_healgun, WeaponHealgun, C_BaseHLCombatWeapon );
#ifdef HL2_EPISODIC
