...
public:
	...
	virtual const char		*GetViewModelRed(int viewmodelindex = 0) const;
	virtual const char		*GetViewModelBlue(int viewmodelindex = 0) const;
	...
	virtual int				GetBotWeaponRange(void) const;
	...
	void AddPrimaryAmmoCount(int count) { m_iPrimaryAmmoCount += count; }

	int GetSecondaryAmmoCount() { return m_iSecondaryAmmoCount; }
	void SetSecondaryAmmoCount( int count ) { m_iSecondaryAmmoCount = count; }
	void AddSecondaryAmmoCount(int count) { m_iSecondaryAmmoCount += count; }
